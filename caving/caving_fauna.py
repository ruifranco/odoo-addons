...
class caving_fauna(orm.Model):
    ...
    _columns = {
        ...
        'hibernation_start' : fields.date('Hibernation (start)'),
        'hibernation_end'   : fields.date('Hibernation (end)'),
        ...
        'image_medium': fields.function(_get_image, fnct_inv=_set_image,
            ...
            store = {
                'caving.fauna': (lambda self, cr, uid, ids, c={}: ids, ['image'], 10),
            },
        ...
        'cave_ids'     : fields.many2many('caving.cave', 'caving_cave_fauna_rel', 'fauna_id', 'cave_id', 'Caves'),
    }
